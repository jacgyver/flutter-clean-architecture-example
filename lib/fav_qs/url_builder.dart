class UrlBuilder {
  ...
  String buildGetQuoteListPageUrl(
    ...
    assert(
        (tag == null && searchTerm.isEmpty) || (searchTerm.isEmpty && favoritedByUsername == null) || (favoritedByUsername == null && tag == null),
    ...
    final searchQueryStringPart = searchTerm.isNotEmpty ? '&filter=$searchTerm' : '';
